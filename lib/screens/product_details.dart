...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  buildBrandRow() {
    print('branf: ${_productDetails.brand.logo}');
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(5),
                    child: (_productDetails.brand.logo != null)
                        ? FadeInImage.assetNetwork(
                            placeholder: 'assets/placeholder.png',
  ...
  buildProductImageSection() {
    if (_productImageList.length == 0) {
      ...
      print('current image: ${_productImageList[_currentImage]}');
      return Row(
        ...
        children: [
            ...
            child: Scrollbar(
              ...
              child: Padding(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      int itemIndex = index;
                      print('$index : ${_productImageList[index]}');
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Container(
                child: (_productImageList[_currentImage] != null)
                    ? FadeInImage.assetNetwork(
